<template>
  <div
    ...
    :class="{ 'overflow-hidden': LogicUI.isSideMenuOpen }"
  >
    <Sidebar />
    <div class="flex flex-col flex-1 w-full">
      ...
      <main class="h-full pb-16 overflow-y-auto">
        <div class="container px-6 mx-auto grid">
          ...
          <div
            class="px-4 py-2 mb-4 bg-white rounded-lg shadow-md dark:bg-gray-800"
          >
            <ol
              class="flex items-center w-full p-3 space-x-2 text-sm font-medium text-center text-gray-500 bg-white dark:text-gray-400 sm:text-base dark:bg-gray-800 sm:p-4 sm:space-x-4"
            >
